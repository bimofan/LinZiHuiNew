...
import com.easemob.chatuidemo.fragment.FourFragment;
import com.easemob.chatuidemo.fragment.OneFragment;
import com.easemob.chatuidemo.fragment.ThreeFragment;
import com.easemob.chatuidemo.fragment.TwoFragment;
...
public class MainActivity extends BaseActivity implements EMEventListener {
	...
	// 未读消息textview
	private TextView unreadLabel,mTvTitle;
	// 未读通讯录textview
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 添加显示第一个fragment
		getSupportFragmentManager().beginTransaction().add(R.id.fragment_container, oneFragment)
				.add(R.id.fragment_container, TwoFragment).hide(TwoFragment).show(oneFragment)
				.commit();
	...
	private void initView() {
		...
		findViewById(R.id.iv_new_contact).setVisibility(View.VISIBLE);
		unreadLabel = (TextView) findViewById(R.id.unread_msg_number);
		unreadAddressLable = (TextView) findViewById(R.id.unread_address_number);
		mTabs = new Button[4];
		mTabs[0] = (Button) findViewById(R.id.btn_conversation);
		mTabs[1] = (Button) findViewById(R.id.btn_address_list);
		mTabs[2] = (Button) findViewById(R.id.btn_three);
		mTabs[3] = (Button) findViewById(R.id.btn_setting);
		// 把第一个tab设为选中状态
		mTabs[0].setSelected(true);
		mTvTitle.setText(R.string.session);
	...
	public void onTabClicked(View view) {
		...
		case R.id.btn_address_list:
			mTvTitle.setText(R.string.address_book);
			index = 1;
			break;
		case R.id.btn_three:
			mTvTitle.setText(R.string.three_tab);
			index = 2;
			break;
		case R.id.btn_setting:
			mTvTitle.setText(R.string.my_tab);
			index = 3;
			break;
		}
	...
	public class MyConnectionListener implements EMConnectionListener {
		...
		public void onConnected() {
			...
			runOnUiThread(new Runnable() {
				...
				@Override
				public void run() {
					oneFragment.errorItem.setVisibility(View.GONE);
				}
			...
			runOnUiThread(new Runnable() {
				...
				public void run() {
					if (error == EMError.USER_REMOVED) {
						...
						oneFragment.errorItem.setVisibility(View.VISIBLE);
						if (NetUtils.hasNetwork(MainActivity.this))
							oneFragment.errorText.setText(st1);
						else
							oneFragment.errorText.setText(st2);
